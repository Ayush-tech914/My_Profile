        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Ayush Panda</a></h1>
              <span className="email"><i className="icon-mail"></i>ayushpanda9439@gmail.com</span>
            </div>
            <nav id="colorlib-main-menu" role="navigation" className="navbar">
              <div id="navbar" className="collapse">
                <ul>
                  ...
                  <li><a href="https://github.com/Ayush-tech914" data-nav-section="projects">Projects</a></li>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://github.com/Ayush-tech914" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
